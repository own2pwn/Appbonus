...
public class TickPlusDrawable extends Drawable {
    ...
    private List<OnDrawListener> listeners = new LinkedList<OnDrawListener>();
    ...
    public boolean addListener(OnDrawListener listener) {
        return listeners.add(listener);
    }

    public boolean removeListener(OnDrawListener listener) {
